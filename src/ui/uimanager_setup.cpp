...
void UiManager::setupLogTable()
{
    ...
    // Date off (the day rarely matters live), everything else on: a log tool
    // that hides the time by default only confuses.
    applyColumnVisibility({false, true, true, true, true, true, true, true});
